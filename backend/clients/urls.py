...
urlpatterns = [
    ...
    path('follow-up/', views.FollowUpListCreateAPIView.as_view(), name='FollowUpListCreateAPIView'),
    path('follow-up/<int:id>/', views.FollowUpRetrieveUpdateDestroyAPIView.as_view(), name='FollowUpRetrieveUpdateDestroyAPIView'),
