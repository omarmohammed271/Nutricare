...
// Submit client file data to the API
...
// Update client file data
export const updateClientFile = async (clientId: string, data: ClientFileData) => {
  try {
    const response = await httpClient.put(`/clients/${clientId}/`, data);
    return response.data;
  } catch (error) {
