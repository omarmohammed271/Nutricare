...
const authRoutes: RoutesProps[] = [
  ...
  { path: "/admin/auth/login", element: <LoadComponent component={lazy(() => import("@src/pages/auth/LoginAdmin/admin"))} /> },
  { path: "/admin/auth/recover-password", element: <LoadComponent component={lazy(() => import("@src/pages/auth/resetPassAdmin/resetPassAdmin"))} /> },
